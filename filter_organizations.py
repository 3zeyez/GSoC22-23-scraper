...
def filter():
    ...
    with open("csv_files/organizations.csv", "r") as f:
        ...
        for organization in organizations:
            ...
            technologies_of_org = driver.find_element(
                By.CLASS_NAME, "tech__content"
            ).text.split(", ")
            topics_of_org = driver.find_element(
                By.CLASS_NAME, "topics__content"
            ).text.split(", ")
            ...
            score_tech_according_me = len(matches_technologies * 100) / len(
                my_technologies
            )
            score_tech_according_org = len(matches_technologies * 100) / len(
                technologies_of_org
            )
            ...
            score_according_me = (
                score_tech_according_me + score_topic_according_me
            ) / 2
            score_according_org = (
                score_tech_according_org + score_topic_according_org
            ) / 2
            score = (score_according_me + score_according_org) / 2
            ...
            if matches_technologies != [] and matches_topics != []:
                try:
                    link = driver.find_element(
                        By.XPATH,
                        "/html/body/app-root/app-layout/mat-sidenav-container/mat-sidenav-content/div/div/main/app-program-organization/app-org-info/section/div[2]/div/div/div[1]/div/app-org-info-details/div/div[2]/a",
                    ).text
                    ...
                    pass
                try:
                    guidance_link = driver.find_element(
                        By.XPATH,
                        "/html/body/app-root/app-layout/mat-sidenav-container/mat-sidenav-content/div/div/main/app-program-organization/section/div/div[2]/a",
                    ).text
